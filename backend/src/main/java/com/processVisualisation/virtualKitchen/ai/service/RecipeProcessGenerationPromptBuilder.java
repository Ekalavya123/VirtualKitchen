...
public class RecipeProcessGenerationPromptBuilder {
    ...
    /** Process's own fixed unit enum (UnitType) — distinct from the step catalog's broader unit list, so not sourced from {@link RecipeStepVocabularyProvider}. */
    private static final String UNIT_IDS = "COUNT|GRAM|KG|ML|LITER";

    private final RecipeStepVocabularyProvider recipeStepVocabularyProvider;

    public RecipeProcessGenerationPromptBuilder(RecipeStepVocabularyProvider recipeStepVocabularyProvider) {
        this.recipeStepVocabularyProvider = recipeStepVocabularyProvider;
    }
    ...
    private String buildSchemaAndRulesBlock() {
        return """
                ...
                """.formatted(
                recipeStepVocabularyProvider.actionIds(),
                recipeStepVocabularyProvider.ingredientIds(),
                UNIT_IDS,
                recipeStepVocabularyProvider.preparationStyleIds(),
                recipeStepVocabularyProvider.flameLevelIds()
        );
    }
}
