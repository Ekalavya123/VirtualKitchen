...
/**
 * Internal milestones of a single {@link ProcessGenerationJob} run, mirroring
 * {@link RecipeFlowGenerationStage}. There is no PERSISTING stage here: the
 ...
 */
public enum ProcessGenerationStage {
    QUEUED(0),
    BUILDING_PROMPT(10),
    CALLING_MODEL(40),
    ...
    ProcessGenerationStage(int percent) {
