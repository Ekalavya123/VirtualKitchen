 ...
 * (distinct from ProcessSidebar.tsx, which is the node-quick-add sidebar
 * *inside* one process's own canvas, and from the standalone
 * ProcessListPage, which is a full page). Selecting a process here just
 ...
 */
export default function ProcessListSidebar({
  processes,
  selectedProcessId,
  isOwner,
  onSelect,
